...
x_mode1 = [4.07609, 7.8125, 44.734, 3.125];
y_mode1 = [0.9029, 0.975933, 1.8051, 0.90336];
% x_mode1 = [x_mode1; Z_t];
...
x_mode15 = [9.375,0.82,2.8125, 2.5];
y_mode15 = [2.18, 1.4718, 1.8861, 1.6672];
...
xlabel('Z/t');
ylabel('Lp/W');
legend('Mode 1', 'Mode 2', 'Mode 3', 'Mode 1.5', 'Mode 2.5');