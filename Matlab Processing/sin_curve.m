filePath = '/home/s2239369/Internship/FEA results/9/variables.dat';
...
for i = 1:(row1_end - row1_start + 1)
    ...
    y_diff = abs(displacement_y(row1_index)-displacement_y(176));
...
figure;
scatter(all_x_final(:,28), all_displacement_y(:,28 ));
